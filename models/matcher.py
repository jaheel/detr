...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        # bs = outputs["pred_logits"][0] = batch_size
        # num_queries = outputs["pred_logits"][1] = num_queries
        ...
        # cost_class : (batch_size * num_queries, 1)
        cost_class = -out_prob[:, tgt_ids]
        # ----------------------------------

        # ----------------------------------
        # Compute the L1 cost between boxes
        # cost_bbox : (batch_size * num_queries, 1)
        cost_bbox = torch.cdist(out_bbox, tgt_bbox, p=1)
        # ----------------------------------

        # ----------------------------------
        # Compute the giou cost betwen boxes
        # cost_giou : (batch_size * num_queries, batch_size * num_queries)
        ...
        # C : (batch_size, num_queries, batch_size * num_queries)
